package net.ankio.materialthemebuilder.generator;


import com.google.common.base.CaseFormat;

import net.ankio.materialthemebuilder.MaterialTheme;
import net.ankio.materialthemebuilder.MaterialThemeBuilderExtension;
import net.ankio.materialthemebuilder.Util;
...
public class ValuesV31Generator extends ValuesGenerator {
    ...
    private int type = 0;
    public ValuesV31Generator(File file, MaterialThemeBuilderExtension extension,int type) {
        super(file);
